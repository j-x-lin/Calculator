...
public class SubOpTest {
    ...
    {
        assertEquals(3.0, sub.calculate(new Number[]{5.0, 2.0}));
        assertEquals(-3.0, sub.calculate(new Number[]{2.0, 5.0}));
        assertEquals(3.0, sub.calculate(new Number[]{3.0, .0}));
        assertEquals(-3.0, sub.calculate(new Number[]{.0, 3.0}));
        assertEquals(13.0, sub.calculate(new Number[]{8.0, -5.0}));
        assertEquals(-13.0, sub.calculate(new Number[]{-5.0, 8.0}));
        assertEquals(.0, sub.calculate(new Number[]{-12.0, -12.0}));
        assertEquals(.0, sub.calculate(new Number[]{12.0, 12.0}));
        assertEquals(0.0, sub.calculate(new Number[]{.0, .0}));
        assertEquals(1.0, sub.calculate(new Number[]{-1.0, -2.0}));
        assertEquals(-1.0, sub.calculate(new Number[]{-2.0, -1.0}));

        assertEquals(-30.0, sub.calculate(new Number[]{25.0, 55.0}));
        assertEquals(30.0, sub.calculate(new Number[]{55.0, 25.0}));
        assertEquals(80.0, sub.calculate(new Number[]{25.0, -55.0}));
        assertEquals(-80.0, sub.calculate(new Number[]{-55.0, 25.0}));
        ...
        assertEquals(-.5, sub.calculate(new Number[]{.5, 1.0}));
        assertEquals(0.0, sub.calculate(new Number[]{-.5, -0.5}));
    ...
    public void testMixedTypes() {
        assertEquals(0.5, sub.calculate(new Number[]{-.5, -1}));
        assertEquals(-1.5, sub.calculate(new Number[]{-.5, 1.0}));
        assertEquals(-0.5, sub.calculate(new Number[]{0, .5}));
        assertEquals(1000.625, sub.calculate(new Number[]{1000, -.625}));
    }
    ...
    public void testOverUnderFlow() {
        ...
        assertEquals(0.0, sub.calculate(new Number[]{-Double.MIN_VALUE, -Double.MIN_VALUE}));
        assertEquals(0.0, sub.calculate(new Number[]{-Double.MAX_VALUE, -Double.MAX_VALUE}));
        assertEquals(0.0, sub.calculate(new Number[]{Double.MAX_VALUE, Double.MAX_VALUE}));
    }
    ...
    public void testNaNInfinity() {
        ...
        assertEquals(Double.POSITIVE_INFINITY, sub.calculate(new Number[]{Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY}));
        assertEquals(Double.NaN, sub.calculate(new Number[]{Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY}));
        assertEquals(Double.NEGATIVE_INFINITY, sub.calculate(new Number[]{Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY}));
        assertEquals(Double.NaN, sub.calculate(new Number[]{Double.NaN, -1}));
    }
}
